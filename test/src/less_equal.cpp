...
TEST_CASE("less_equal/s/0", "[float][less_equal]") {
    const size_t N = 137;
    ...
    egblas_sless_equal(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("less_equal/s/1", "[float][less_equal]") {
    const size_t N = 333;
...
TEST_CASE("less_equal/d/0", "[double][less_equal]") {
    const size_t N = 137;
    ...
    egblas_dless_equal(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("less_equal/d/1", "[double][less_equal]") {
    const size_t N = 333;
...
TEST_CASE("less_equal/c/0", "[float][less_equal]") {
    const size_t N = 137;
    ...
    egblas_cless_equal(N, reinterpret_cast<cuComplex*>(a_gpu), 1, reinterpret_cast<cuComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("less_equal/c/1", "[float][less_equal]") {
    const size_t N = 338;
...
TEST_CASE("less_equal/z/0", "[double][less_equal]") {
    const size_t N = 137;
    ...
    egblas_zless_equal(N, reinterpret_cast<cuDoubleComplex*>(a_gpu), 1, reinterpret_cast<cuDoubleComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("less_equal/z/1", "[double][less_equal]") {
    const size_t N = 338;
