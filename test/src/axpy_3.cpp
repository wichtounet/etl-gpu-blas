...
TEST_CASE("axpy_3/s/0", "[float][axpy_3]") {
    ...
    egblas_saxpy_3(N, 1.0, x_gpu, 1, y_gpu, 1, yy_gpu, 1);
...
TEST_CASE("axpy_3/s/1", "[float][axpy_3]") {
    ...
    egblas_saxpy_3(N, 0.2, x_gpu, 1, y_gpu, 1, yy_gpu, 1);
...
TEST_CASE("axpy_3/s/2", "[float][axpy_3]") {
    ...
    egblas_saxpy_3(N, 0.2, x_gpu, 3, y_gpu, 3, yy_gpu, 1);
...
TEST_CASE("axpy_3/d/0", "[double][axpy_3]") {
    ...
    egblas_daxpy_3(N, 1.0, x_gpu, 1, y_gpu, 1, yy_gpu, 1);
...
TEST_CASE("axpy_3/d/1", "[double][axpy_3]") {
    ...
    egblas_daxpy_3(N, 0.2, x_gpu, 1, y_gpu, 1, yy_gpu, 1);
...
TEST_CASE("axpy_3/d/2", "[double][axpy_3]") {
    ...
    egblas_daxpy_3(N, 0.2, x_gpu, 3, y_gpu, 3, yy_gpu, 1);
...
TEST_CASE("axpy_3/c/0", "[float][axpy_3]") {
    ...
    egblas_caxpy_3(N, make_cuComplex(1.0, 0.0), reinterpret_cast<cuComplex*>(x_gpu), 1, reinterpret_cast<cuComplex*>(y_gpu), 1, reinterpret_cast<cuComplex*>(yy_gpu), 1);

    cuda_check(cudaMemcpy(yy_cpu, yy_gpu, N * sizeof(std::complex<float>), cudaMemcpyDeviceToHost));

    for (size_t i = 0; i < N; ++i) {
        REQUIRE(yy_cpu[i].real() == Approx(i + -2.0f * i));
        REQUIRE(yy_cpu[i].imag() == Approx(i +  0.1f * i));
    }
...
TEST_CASE("axpy_3/c/1", "[float][axpy_3]") {
    ...
    for (size_t i = 0; i < N; ++i) {
        REQUIRE(yy_cpu[i].real() == Approx(i + -1.0f * i));
        REQUIRE(yy_cpu[i].imag() == Approx(i +  0.1f * i));
    }
...
TEST_CASE("axpy_3/z/0", "[double][axpy_3]") {
    ...
    egblas_zaxpy_3(N, make_cuDoubleComplex(1.0, 0.0), reinterpret_cast<cuDoubleComplex*>(x_gpu), 1, reinterpret_cast<cuDoubleComplex*>(y_gpu), 1, reinterpret_cast<cuDoubleComplex*>(yy_gpu), 1);
...
TEST_CASE("axpy_3/z/1", "[double][axpy_3]") {
    ...
    for (size_t i = 0; i < N; ++i) {
        REQUIRE(yy_cpu[i].real() == Approx(i + -1.0f * i));
        REQUIRE(yy_cpu[i].imag() == Approx(-1.0 * i +  2.1f * i));
    }
