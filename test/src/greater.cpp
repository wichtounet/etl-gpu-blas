...
TEST_CASE("greater/s/0", "[float][greater]") {
    const size_t N = 137;
    ...
    egblas_sgreater(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("greater/s/1", "[float][greater]") {
    const size_t N = 333;
...
TEST_CASE("greater/d/0", "[double][greater]") {
    const size_t N = 137;
    ...
    egblas_dgreater(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("greater/d/1", "[double][greater]") {
    const size_t N = 333;
...
TEST_CASE("greater/c/0", "[float][greater]") {
    const size_t N = 137;
    ...
    egblas_cgreater(N, reinterpret_cast<cuComplex*>(a_gpu), 1, reinterpret_cast<cuComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("greater/c/1", "[float][greater]") {
    const size_t N = 338;
...
TEST_CASE("greater/z/0", "[double][greater]") {
    const size_t N = 137;
    ...
    egblas_zgreater(N, reinterpret_cast<cuDoubleComplex*>(a_gpu), 1, reinterpret_cast<cuDoubleComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("greater/z/1", "[double][greater]") {
    const size_t N = 338;
