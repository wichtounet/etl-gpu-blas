...
TEST_CASE("greater_equal/s/0", "[float][greater_equal]") {
    const size_t N = 137;
    ...
    egblas_sgreater_equal(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("greater_equal/s/1", "[float][greater_equal]") {
    const size_t N = 333;
...
TEST_CASE("greater_equal/d/0", "[double][greater_equal]") {
    const size_t N = 137;
    ...
    egblas_dgreater_equal(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("greater_equal/d/1", "[double][greater_equal]") {
    const size_t N = 333;
...
TEST_CASE("greater_equal/c/0", "[float][greater_equal]") {
    const size_t N = 137;
    ...
    egblas_cgreater_equal(N, reinterpret_cast<cuComplex*>(a_gpu), 1, reinterpret_cast<cuComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("greater_equal/c/1", "[float][greater_equal]") {
    const size_t N = 338;
...
TEST_CASE("greater_equal/z/0", "[double][greater_equal]") {
    const size_t N = 137;
    ...
    egblas_zgreater_equal(N, reinterpret_cast<cuDoubleComplex*>(a_gpu), 1, reinterpret_cast<cuDoubleComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("greater_equal/z/1", "[double][greater_equal]") {
    const size_t N = 338;
