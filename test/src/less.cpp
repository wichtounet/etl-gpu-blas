...
TEST_CASE("less/s/0", "[float][less]") {
    ...
    egblas_sless(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("less/d/0", "[double][less]") {
    const size_t N = 137;
    ...
    egblas_dless(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("less/d/1", "[double][less]") {
    const size_t N = 333;
...
TEST_CASE("less/c/0", "[float][less]") {
    ...
    egblas_cless(N, reinterpret_cast<cuComplex*>(a_gpu), 1, reinterpret_cast<cuComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("less/z/0", "[double][less]") {
    const size_t N = 137;
    ...
    egblas_zless(N, reinterpret_cast<cuDoubleComplex*>(a_gpu), 1, reinterpret_cast<cuDoubleComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("less/z/1", "[double][less]") {
    const size_t N = 338;
