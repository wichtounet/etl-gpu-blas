...
TEST_CASE("not_equal/s/0", "[float][not_equal]") {
    const size_t N = 137;
    ...
    egblas_snot_equal(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("not_equal/s/1", "[float][not_equal]") {
    const size_t N = 333;
...
TEST_CASE("not_equal/d/0", "[double][not_equal]") {
    const size_t N = 137;
    ...
    egblas_dnot_equal(N, a_gpu, 1, b_gpu, 1, y_gpu, 1);
...
TEST_CASE("not_equal/d/1", "[double][not_equal]") {
    const size_t N = 333;
...
TEST_CASE("not_equal/c/0", "[float][not_equal]") {
    const size_t N = 137;
    ...
    egblas_cnot_equal(N, reinterpret_cast<cuComplex*>(a_gpu), 1, reinterpret_cast<cuComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("not_equal/c/1", "[float][not_equal]") {
    const size_t N = 338;
...
TEST_CASE("not_equal/z/0", "[double][not_equal]") {
    const size_t N = 137;
    ...
    egblas_znot_equal(N, reinterpret_cast<cuDoubleComplex*>(a_gpu), 1, reinterpret_cast<cuDoubleComplex*>(b_gpu), 1, y_gpu, 1);
...
TEST_CASE("not_equal/z/1", "[double][not_equal]") {
    const size_t N = 338;
