 ...
 */
void egblas_sequal(size_t n, const float* x, size_t incx, const float* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_dequal(size_t n, const double* x, size_t incx, const double* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_cequal(size_t n, const cuComplex* x, size_t incx, const cuComplex* z, size_t incz, bool* y, size_t incy);
...
#define EGBLAS_HAS_SEQUAL true
#define EGBLAS_HAS_DEQUAL true
#define EGBLAS_HAS_CEQUAL true
#define EGBLAS_HAS_ZEQUAL true
