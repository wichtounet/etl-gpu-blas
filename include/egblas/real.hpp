...
/*!
 * \brief Compute y = alpha * real(x) (element wise), in complex single-precision
...
/*!
 * \brief Compute y = alpha * real(x) (element wise), in complex double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
#define EGBLAS_HAS_CREAL true
#define EGBLAS_HAS_ZREAL true
