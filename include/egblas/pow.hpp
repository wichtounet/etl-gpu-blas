...
/*!
 * \brief Compute y = alpha * pow(x,y) (element wise), in single-precision
...
/*!
 * \brief Compute y = alpha * pow(x,y) (element wise), in double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
/*!
 * \brief Compute y = alpha * pow(x,y) (element wise), in complex single-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
/*!
 * \brief Compute y = alpha * pow(x,y) (element wise), in complex double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
#define EGBLAS_HAS_SPOW true
#define EGBLAS_HAS_DPOW true
#define EGBLAS_HAS_CPOW true
#define EGBLAS_HAS_ZPOW true
