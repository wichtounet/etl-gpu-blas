 ...
 */
void egblas_snot_equal(size_t n, const float* x, size_t incx, const float* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_dnot_equal(size_t n, const double* x, size_t incx, const double* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_cnot_equal(size_t n, const cuComplex* x, size_t incx, const cuComplex* z, size_t incz, bool* y, size_t incy);
...
#define EGBLAS_HAS_SNOT_EQUAL true
#define EGBLAS_HAS_DNOT_EQUAL true
#define EGBLAS_HAS_CNOT_EQUAL true
#define EGBLAS_HAS_ZNOT_EQUAL true
