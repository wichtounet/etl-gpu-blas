...
/*!
 * \brief Compute y = alpha * sin(x) (element wise), in single-precision
...
/*!
 * \brief Compute y = alpha * sin(x) (element wise), in double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
/*!
 * \brief Compute y = alpha * sin(x) (element wise), in complex single-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
/*!
 * \brief Compute y = alpha * sin(x) (element wise), in complex double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
#define EGBLAS_HAS_SSIN true
#define EGBLAS_HAS_DSIN true
#define EGBLAS_HAS_CSIN true
#define EGBLAS_HAS_ZSIN true
