 ...
 */
void egblas_sless_equal(size_t n, const float* x, size_t incx, const float* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_dless_equal(size_t n, const double* x, size_t incx, const double* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_cless_equal(size_t n, const cuComplex* x, size_t incx, const cuComplex* z, size_t incz, bool* y, size_t incy);
...
#define EGBLAS_HAS_SLESS_EQUAL true
#define EGBLAS_HAS_DLESS_EQUAL true
#define EGBLAS_HAS_CLESS_EQUAL true
#define EGBLAS_HAS_ZLESS_EQUAL true
