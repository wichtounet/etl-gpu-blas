...
/*!
 * \brief Compute y = alpha * -x (element wise), in minusgle-precision
...
/*!
 * \brief Compute y = alpha * -x (element wise), in double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
/*!
 * \brief Compute y = alpha * -x (element wise), in complex minusgle-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
/*!
 * \brief Compute y = alpha * -x (element wise), in complex double-precision
 * \param n The size of the two vectors
 * \param alpha The multiplicator
 * \param x The vector x (GPU memory)
 * \param incx The stride of x
...
#define EGBLAS_HAS_SMINUS true
#define EGBLAS_HAS_DMINUS true
#define EGBLAS_HAS_CMINUS true
#define EGBLAS_HAS_ZMINUS true
