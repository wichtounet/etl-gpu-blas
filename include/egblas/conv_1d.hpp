...
/*!
 * \brief Compute y = alpha * conv_1d_full(x, y), in single-precision
 * \param N The input size
 * \param K The kernel size
 * \param alpha The scaling factor
 * \param x The input vector
...
/*!
 * \brief Compute y = alpha * conv_1d_full(x, y), in double-precision
 * \param N The input size
 * \param K The kernel size
 * \param alpha The scaling factor
 * \param x The input vector
...
#define EGBLAS_HAS_SCONV1_FULL true
#define EGBLAS_HAS_DCONV1_FULL true
