 ...
 */
void egblas_sgreater_equal(size_t n, const float* x, size_t incx, const float* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_dgreater_equal(size_t n, const double* x, size_t incx, const double* z, size_t incz, bool* y, size_t incy);
 ...
 * \param incy The stride of y
 */
void egblas_cgreater_equal(size_t n, const cuComplex* x, size_t incx, const cuComplex* z, size_t incz, bool* y, size_t incy);
...
#define EGBLAS_HAS_SGREATER_EQUAL true
#define EGBLAS_HAS_DGREATER_EQUAL true
#define EGBLAS_HAS_CGREATER_EQUAL true
#define EGBLAS_HAS_ZGREATER_EQUAL true
